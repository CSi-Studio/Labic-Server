...
public enum ResultCode implements Serializable {
    ...
    LIB_MZVAULT_FILE_TYPE("LIB_MZVAULT_FILE_TYPE", "mzvault需要传输文件类型错误"),
    /**
     * ******
     * run
     * *******
    ...
    UNKNOWN_FILE_FORMAT("UNKNOWN_FILE_FORMAT", "未知的文件格式"),
    ...
    OVERVIEWS_NOT_IN_COMMON_PROJECT("OVERVIEWS_NOT_IN_COMMON_PROJECT", "预览不在同一个项目下"),
    ...
    NONE_OF_EXPORT_TASK("NONE_OF_EXPORT_TASK", "NONE_OF_EXPORT_TASK"),
    NOT_SELECTED("NOT_SELECTED", "未选择目标"),
    ;
