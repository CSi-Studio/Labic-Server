package net.csibio.labic.dao;

import net.csibio.labic.domain.bean.common.IdName;
import net.csibio.labic.domain.bean.common.IdNameType;
import net.csibio.labic.domain.query.PageQuery;
import net.csibio.labic.service.IDAO;
...
public abstract class BaseDAO<T, Q extends PageQuery> implements IDAO<T, Q> {
    ...
    public void remove(Q query) {
        mongoTemplate.remove(buildQueryWithoutPage(query), getDomainClass(), getCollectionName());
    }
    ...
    public List<T> getByIds(String[] ids) {
        ...
        return mongoTemplate.find(query, getDomainClass(), getCollectionName());
    }
