...
import net.csibio.labic.exceptions.XException;
...
public class MD5Utils {
     ...
     */
    public static boolean getSaltverifyMD5(String password, String md5str) throws XException {
        try {
           ...
           throw new XException(ResultCode.PHONE_OR_PASSWORD_ERROR);
        }
    }
